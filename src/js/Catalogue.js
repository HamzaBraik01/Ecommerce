        ...
        data.forEach((product, index) => {
            ...
            card.innerHTML += `   <div class="bg-white p-4" style="border-radius: 15px; box-shadow: 8px 8px 8px rgba(252, 103, 54, 0.5);">
                        <div class="flex flex-col items-center mb-2">
                            ...
                            <a href='/src/Detail.html?${product.id}'><h3 class="font-bold text-md mb-2" style='height: 50px; display: flex; align-items: center;'>${product.name}</h3></a>
                            ...
                            <div class="flex justify-center space-x-4">
                                <button style="background-color: #FC6736;" class="text-white px-2 py rounded-full">Add to Cart</button>
                                 <a href='/src/Detail.html?${product.id}'><button style="background-color: #FC6736;" class="text-white px-2 py rounded-full">Customize</button></a>
                            </div>
                        </div>
                    </div>`;
        })
